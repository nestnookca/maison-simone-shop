...
<defs>
  ...
  <symbol id="i-bottle" viewBox="0 0 100 100">
    <rect x="34" y="10" width="14" height="12" rx="2" fill="none" stroke="url(#goldGrad)" stroke-width="2"/>
    <path d="M30 24 h22 v8 c8 6 10 14 10 24 v24 a6 6 0 0 1-6 6 H26 a6 6 0 0 1-6-6 V56 c0-10 2-18 10-24z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
  ...
  <symbol id="i-jar" viewBox="0 0 100 100">
    <rect x="24" y="16" width="40" height="10" rx="2" fill="none" stroke="url(#goldGrad)" stroke-width="2.2"/>
    <path d="M20 30 h48 l-4 46 a8 8 0 0 1-8 8 H32 a8 8 0 0 1-8-8z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
  ...
  <symbol id="i-pump" viewBox="0 0 100 100">
    <path d="M40 6 l14 8 v10 h-14z" fill="none" stroke="url(#goldGrad)" stroke-width="2"/>
    <rect x="28" y="26" width="26" height="56" rx="6" fill="none" stroke="url(#goldGrad)" stroke-width="2.2"/>
  ...
  <symbol id="i-dropper" viewBox="0 0 100 100">
    <path d="M42 6 h16 v18 l-4 4 v50 a4 4 0 0 1-8 0 V28 l-4-4z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
    <ellipse cx="50" cy="14" rx="7" ry="5" fill="none" stroke="url(#goldGrad)" stroke-width="1.6"/>
    <line x1="40" y1="46" x2="60" y2="46" stroke="url(#goldGrad)" stroke-width="1" opacity=".4"/>
  </symbol>

  <symbol id="i-tube" viewBox="0 0 100 100">
    <path d="M38 10 h24 l-2 14 h-20z" fill="none" stroke="url(#goldGrad)" stroke-width="2"/>
    <path d="M36 24 h28 c4 20 6 34 2 50 c-1 5-6 8-16 8s-15-3-16-8c-4-16-2-30 2-50z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
    <line x1="34" y1="40" x2="66" y2="40" stroke="url(#goldGrad)" stroke-width="1.1" opacity=".5"/>
  </symbol>

  <symbol id="i-led" viewBox="0 0 100 100">
    <rect x="14" y="24" width="72" height="52" rx="10" fill="none" stroke="url(#goldGrad)" stroke-width="2.2"/>
  ...
  <symbol id="i-steam" viewBox="0 0 100 100">
    <path d="M50 14 C30 30 26 46 34 58 h32 C74 46 70 30 50 14z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
    <rect x="22" y="58" width="56" height="14" rx="3" fill="none" stroke="url(#goldGrad)" stroke-width="2.2"/>
    <rect x="30" y="72" width="40" height="10" rx="2" fill="none" stroke="url(#goldGrad)" stroke-width="2"/>
  ...
  <symbol id="i-rf" viewBox="0 0 100 100">
    <circle cx="50" cy="26" r="16" fill="none" stroke="url(#goldGrad)" stroke-width="2.2"/>
    <circle cx="50" cy="26" r="7" fill="none" stroke="url(#goldGrad)" stroke-width="1.6"/>
    <path d="M42 40 l-10 44 a4 4 0 0 0 4 5h28 a4 4 0 0 0 4-5l-10-44z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
    <line x1="44" y1="60" x2="56" y2="60" stroke="url(#goldGrad)" stroke-width="1.2" opacity=".5"/>
  </symbol>

  <symbol id="i-derma" viewBox="0 0 100 100">
    <path d="M50 8 l8 10 v56 a8 8 0 0 1-16 0V18z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
    <line x1="42" y1="34" x2="58" y2="34" stroke="url(#goldGrad)" stroke-width="1.2" opacity=".5"/>
    <path d="M44 82 l6 10 6-10z" fill="none" stroke="url(#goldGrad)" stroke-width="2" stroke-linejoin="round"/>
  </symbol>

  <symbol id="i-guasha" viewBox="0 0 100 100">
    <path d="M50 14 C22 20 20 48 34 64 c6 7 8 14 8 20 h16 c0-6 2-13 8-20 14-16 12-44-16-50z" fill="none" stroke="url(#goldGrad)" stroke-width="2.2" stroke-linejoin="round"/>
    <path d="M40 30 q10-8 20 0" fill="none" stroke="url(#goldGrad)" stroke-width="1.4" opacity=".6"/>
  </symbol>

  <symbol id="i-wand" viewBox="0 0 100 100">
    <circle cx="50" cy="22" r="14" fill="none" stroke="url(#goldGrad)" stroke-width="2.2"/>
    <path d="M50 8 v28 M36 22 h28" stroke="url(#goldGrad)" stroke-width="1.4" opacity=".6"/>
    <rect x="44" y="36" width="12" height="50" rx="5" fill="none" stroke="url(#goldGrad)" stroke-width="2.2"/>
  </symbol>
